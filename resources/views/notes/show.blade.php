            ...
            <div class="flex text-white">
                ...
                @else
                    ...
                    <form action="{{ route('trashed.destroy', $note) }}" method="post">
                        @method('delete')
                        @csrf
                        <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('Are you sure you wish to delete this note forever? This action is irrevocable')">Delete Forever</button>
                    </form>
                @endif
            </div>
